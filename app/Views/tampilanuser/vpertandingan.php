        ...
        <table id="datatable" class="table table-striped table-bordered" style="width:100%">
            <thead style="background-color: #4CAF50; color: white;">
                <tr class="text-center">
                    <td class=""><b>TIM TUAN RUMAH</b></td>
                    <td class=""></td>
                    <td class=""><b>TAMU</b></td>
                    <td><b>STADION</b></td>
                    <td><b>WAKTU</b></td>
                </tr>
            </thead>
            <tbody>
                ...
                foreach ($pertandingan as $jns) { ?>
                    <tr class="text-center">
                        ...
                        <td><?= $jns['stadion']; ?></td>
                        <td><?= $jns['tanggal']; ?></td>
                        <td style="text-align: center;"><a href="<?= base_url('/pembelian/' . $jns["id_pertandingan"]) ?>"><button class="btn btn-sm btn-warning">BELI</button></a></td>
                    </tr>
                <?php } ?>
            </tbody>
        </table>
