...
<body>
    ...
    <nav class="navbar navbar-expand-lg sticky-top navbar-light bg-warning mb-0" style="height: 85px;">
        <div class="container">
            <a class="navbar-brand"><b>Tiket Online</b></a>
    ...
    <h3 class="text-center">Daftar Pertandingan</h3>
                ...
                <div class="col-md-6">
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <p class="card-text">Berikut adalah jadwal pertandingan.</p>
                            <a href="<?= base_url('tampilanuser/' . $category['id_jenis_pertandingan']) ?>" class="btn btn-primary">Lihat</a>
                        </div>
                    </div>
                </div>
            <?php endforeach; ?>
